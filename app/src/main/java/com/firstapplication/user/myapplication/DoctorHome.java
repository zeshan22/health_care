...
import com.firstapplication.user.myapplication.Doctor.DoctorMessageListAdapter;
import com.firstapplication.user.myapplication.Doctor.DoctorPrescriptionList;
...
//                        finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            startActivity(new Intent(DoctorHome.this, docAppointment.class));
            finish();
            return true;
        }
            ...
            mAuth.signOut();
            startActivity(new Intent(DoctorHome.this, identifytheuser.class));
            finish();
            return true;
        }
