...
public class DoctorDetails extends AppCompatActivity {
    ...
    ImageView chatSymbol,videoSymbol;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        videoSymbol = (ImageView) findViewById(R.id.doctor_details_video);
        ...
        videoSymbol.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Intent videoActivty = new Intent(getApplicationContext(),consultDoctor.class);
              //  msgActivity.putExtra("doctor_name",name);
              //  msgActivity.putExtra("doctor_id",doctorId);
