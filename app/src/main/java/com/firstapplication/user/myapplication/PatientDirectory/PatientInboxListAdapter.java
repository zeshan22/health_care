...
import com.firstapplication.user.myapplication.Doctors;
import com.firstapplication.user.myapplication.Helper;
import com.firstapplication.user.myapplication.Message;
import com.firstapplication.user.myapplication.Patient;
...
public class PatientInboxListAdapter extends RecyclerView.Adapter<PatientInboxListAdapter.PatientInboxListViewHolder> {
    ...
    public PatientInboxListAdapter(Context context, ArrayList<Message> mMessageList){
